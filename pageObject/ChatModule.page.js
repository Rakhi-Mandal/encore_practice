...
exports.ChatPage=class ChatPage{
    ...
    //     await chatNameInput.clear();
    //     await chatNameInput.fill(data.groupName);  

    //     const newChatName = 'New Chat Name';
    //     await chatNameInput.fill(newChatName);  
    //     await expect(chatNameInput).toHaveValue(newChatName);

    //     console.log(`Renamed chat to: ${newChatName}`);
    // }
}